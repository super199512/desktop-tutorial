...
<body>
    ...
    <main>
        <section>
            <h2>About</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla condimentum purus ac urna ultricies, a mollis velit convallis. Integer varius velit eu tellus vestibulum iaculis. Sed feugiat velit non tortor mollis gravida.</p>
        </section>
